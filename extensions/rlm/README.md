...
- the TUI widget shows compact sandbox execution results like frame kind, updated variables, subcall targets, and final-output location instead of surfacing the raw control program as the primary UI
